...
var countdownTimer = setInterval(\'secondPassed()\', 1000);
                                ...
                                echo '<span class="timer btn btn-primary" style="margin-left:50px" onclick="end()"><span class=" glyphicon glyphicon-off"></span>&nbsp;&nbsp;<font style="font-size:12px;font-weight:bold">Finish Quiz</font></span>';
                                $eid   = @$_GET['eid'];
                                $sn    = @$_GET['n'];
                                $total = @$_GET['t'];
