        ...
        <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
          <fieldset>
            <div class="form-group">
              ...
              <div class="col-md-12">
                <h3 align="center" style="margin: -3px;">Formulir Registrasi</h3>
            ...
            <div class="form-group">
              <label class="col-md-12 control-label" for="name"></label>
              <div class="col-md-12">
                <input id="name" name="name" placeholder="Masukan Nama Lengkap" class="form-control input-md" type="text" value="<?php
                                                                                                                                  if (isset($_GET['name'])) {
                                                                                                                                    echo $_GET['name'];
                                                                                                                                  } ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="rollno" name="rollno" placeholder="Asal Sekolah" class="form-control input-md" type="text" value="<?php
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="username" name="username" placeholder="Nama Pengguna" class="form-control input-md" type="username" value="<?php
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <input id="phno" name="phno" placeholder="Nomor Telephon" class="form-control input-md" type="number" value="<?php
                                                                                                                              if (isset($_GET['phno'])) {
                                                                                                                                echo $_GET['phno'];
                                                                                                                              }
                                                                                                                              ?>">
